...
class EgoVehicle(Vehicle):
    ...
    def __init__(self, uid, name, parent, node, carla_actor, vehicle_control_applied_callback):
        ...
        self.vehicle_info_publisher = node.new_publisher(
            ...
            "/vehicle_info",
            qos_profile=rclpy.qos.rclpy.qos.QoSProfile(depth=10, durability=rclpy.qos.rclpy.qos.DurabilityPolicy.TRANSIENT_LOCAL))
        ...
        self.control_override_subscriber = node.new_subscription(
            ...
            qos_profile=rclpy.qos.rclpy.qos.QoSProfile(depth=1, durability=rclpy.qos.rclpy.qos.DurabilityPolicy.TRANSIENT_LOCAL))
    ...
    def destroy(self):
        ...
        :return:
        """
        self.node.get_logger().debug("Destroy Vehicle(id={})".format(self.get_id()))
    ...
    def enable_autopilot_updated(self, enable_auto_pilot):
        ...
        :return:
        """
        self.node.get_logger().debug("Ego vehicle: Set autopilot to {}".format(enable_auto_pilot.data))
